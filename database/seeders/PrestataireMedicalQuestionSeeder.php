    ...
    public function run(): void
    {
        ...
        $questionsPharmacie = [
            [
                ...
                'destinataire' => TypePrestataireEnum::PHARMACIE,
        ...
        $questionsCentreSoins = [
            [
                'libelle' => 'Autorisation officielle d\'ouverture',
                'type_de_donnee' => TypeDonneeEnum::FILE,
                'destinataire' => TypePrestataireEnum::CENTRE_DE_SOINS,
                'est_obligatoire' => true,
                'est_active' => true,
            ],
            [
        ...
        $questionsOptique = [
            [
                'libelle' => 'Autorisation officielle d\'ouverture',
                'type_de_donnee' => TypeDonneeEnum::FILE,
                'destinataire' => TypePrestataireEnum::OPTIQUE,
                'est_obligatoire' => true,
                'est_active' => true,
            ],
            [
        ...
        $questionsLaboratoire = [
            [
                'libelle' => 'Autorisation officielle d\'ouverture',
                'type_de_donnee' => TypeDonneeEnum::FILE,
                'destinataire' => TypePrestataireEnum::LABORATOIRE_CENTRE_DIAGNOSTIC,
                'est_obligatoire' => true,
                'est_active' => true,
            ],
            // [
