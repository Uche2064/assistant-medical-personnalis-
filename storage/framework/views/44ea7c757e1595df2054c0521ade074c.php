...
<body>
    ...
    <div class="content">
        <p>Bonjour <?php echo e($user->personne->prenoms ?? $user->personne->nom); ?>,</p>
        
        <p>Votre compte SUNU Santé a été créé avec succès par notre commercial <strong><?php echo e($commercial->personne->prenoms ?? $commercial->personne->nom); ?></strong>.</p>
        
        <div class="credentials">
            <h3>🔑 Vos informations de connexion :</h3>
            <p><strong>Email :</strong> <?php echo e($user->email); ?></p>
            <p><strong>Mot de passe temporaire :</strong> <code><?php echo e($mot_de_passe); ?></code></p>
            <p><strong>Type de compte :</strong> <?php echo e(ucfirst($type_client)); ?></p>
        </div>
        ...
        <div style="text-align: center;">
            <a href="<?php echo e(config('app.frontend_url')); ?>/login" class="button">Se connecter maintenant</a>
        </div>
...
<?php /**PATH D:\projects\amp\amp_backend\resources\views/emails/compte_cree_par_commercial.blade.php ENDPATH**/ ?>