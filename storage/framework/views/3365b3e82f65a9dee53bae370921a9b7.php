...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Bonjour <strong><?php echo e($user->personne->nom ?? $user->email); ?> <?php echo e($user->personne->prenoms ?? ''); ?></strong>,</p>
            ...
            <div class="contrat-details">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><strong><?php echo e(number_format($contrat->prime_standard ?? 0, 0, ',', ' ')); ?> FCFA</strong></td>
                    </tr>
                    <tr>
                        <td>Proposé par :</td>
                        <td><strong><?php echo e($technicien->nom ?? ''); ?> <?php echo e($technicien->prenoms ?? ''); ?></strong></td>
                    </tr>
                    <tr>
                        <td>Date de proposition :</td>
                        <td><strong><?php echo e($proposition->date_proposition ? $proposition->date_proposition->format('d/m/Y à H:i') : now()->format('d/m/Y à H:i')); ?></strong></td>
                    </tr>
                </table>
            </div>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($proposition->commentaires_technicien): ?>
            <div class="commentaires">
                <h4>💬 Commentaires du technicien</h4>
                <p><?php echo e($proposition->commentaires_technicien); ?></p>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <div class="button-container">
                <a href="<?php echo e(config('app.url')); ?>/propositions-contrats" class="button">Voir la proposition</a>
            </div>
...
<?php /**PATH G:\projects\amp\amp_backend\resources\views\emails\proposition_contrat.blade.php ENDPATH**/ ?>