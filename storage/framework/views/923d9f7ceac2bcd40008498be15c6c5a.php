        ...
        <div class="reponse-item">
            ...
            <div class="reponse">
                ...
                <?php elseif($reponse->reponse_fichier): ?>
                    <strong>Fichier joint :</strong> <?php echo e(\App\Helpers\ImageUploadHelper::getFileName($reponse->reponse_fichier)); ?>
                    ...
                    ?>
                    <?php if($fileUrl): ?>
                        <br><small style="color: #2c5aa0;">URL: <?php echo e($fileUrl); ?></small>
                    <?php endif; ?>
                <?php else: ?>
                    Aucune réponse
                <?php endif; ?>
...
</html> <?php /**PATH D:\projects\amp\amp_backend\resources\views/pdf/demande-adhesion.blade.php ENDPATH**/ ?>