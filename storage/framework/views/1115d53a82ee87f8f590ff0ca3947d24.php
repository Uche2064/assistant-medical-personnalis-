        ...
        <div class="content">
            ...
            <div class="details-container">
                ...
                <div class="detail-item">
                    ...
                    <span class="detail-value"><?php echo e($changed_at->format('d/m/Y à H:i')); ?></span>
                </div>
            </div>
            
            <div style="text-align: center; margin-top: 30px; margin-bottom: 30px;">
                <a href="<?php echo e(config('app.frontend_url', 'https://app.sunusante.com')); ?>/login" class="action-button">
...
<?php /**PATH D:\projects\amp\amp_backend\resources\views/emails/password_changed.blade.php ENDPATH**/ ?>