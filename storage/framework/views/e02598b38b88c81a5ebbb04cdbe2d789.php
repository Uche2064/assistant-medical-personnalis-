...
<body>
    <div class="header">
        ...
        <div class="photo-container">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($demande->user->assure && $demande->user->assure->photo_url): ?>
    ...
    <div class="section">
        ...
        <div class="user-info">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($demande->type_demandeur == \App\Enums\TypeDemandeurEnum::CLIENT): ?>
                 <div class="info-row">
                     <span class="info-label">Nom complet :</span>
                     <span class="info-value"><?php echo e($demande->user->assure->nom ?? 'N/A'); ?> <?php echo e($demande->user->assure->prenoms ?? ''); ?></span>
                 </div>
                 <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($demande->user->assure->photo_url): ?>
                 <div class="info-row">
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($demande->user->assure && $demande->user->assure->profession): ?>
            <div class="info-row">
    ...
    <div class="section">
        <div class="section-title">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($demande->type_demandeur->value === 'entreprise'): ?>
                Statistiques de l'entreprise
            <?php elseif($demande->type_demandeur->value === 'client'): ?>
        ...
        <div class="user-info">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($demande->type_demandeur->value === 'entreprise' && $statistiques['total_employes'] > 0): ?>
            <div class="info-row">
                <span class="info-label">Total d'employés :</span>
                <span class="info-value"><?php echo e($statistiques['total_employes']); ?></span>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statistiques['total_beneficiaires'] > 0): ?>
            <div class="info-row">
    ...
    <div class="section beneficiaires-section">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $beneficiaires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="beneficiaire-item">
            <div class="info-row">
                <span class="info-label">Nom complet :</span>
                <span class="info-value"><?php echo e($assure->nom); ?> <?php echo e($assure->prenoms); ?></span>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($assure->photo_url): ?>
            <div class="info-row">
                <span class="info-label">Photo :</span>
                <span class="info-value">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($assure->contact): ?>
            <div class="info-row">
                <span class="info-label">Contact :</span>
                <span class="info-value"><?php echo e($assure->contact); ?></span>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($assure->email): ?>
            <div class="info-row">
                <span class="info-label">Email :</span>
                <span class="info-value"><?php echo e($assure->email); ?></span>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($assure->profession): ?>
            <div class="info-row">
                <span class="info-label">Profession :</span>
                <span class="info-value"><?php echo e($assure->profession); ?></span>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($assure->lien_parente): ?>
            <div class="info-row">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($assure->reponsesQuestionnaire && $assure->reponsesQuestionnaire->count() > 0): ?>
            <div style="margin-top: 10px; padding-top: 10px; border-top: 1px solid #dee2e6;">
                <div style="font-weight: bold; margin-bottom: 5px; color: #2c5aa0;">Réponses au questionnaire :</div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $assure->reponsesQuestionnaire; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reponse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</html> <?php /**PATH G:\projects\amp\amp_backend\resources\views\pdf\demande-adhesion.blade.php ENDPATH**/ ?>