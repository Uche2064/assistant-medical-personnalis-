...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Cher(e) <strong><?php echo e($demande->type_demandeur !== 'client' ? $demande->raison_sociale : $demande->personne->nom . ' ' . $demande->personne->prenoms); ?></strong>,</p>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($contrat) && $contrat): ?>
...
<?php /**PATH G:\projects\amp\amp_backend\resources\views\emails\acceptee.blade.php ENDPATH**/ ?>