...
<body>
    <div class="container">
        ...
        <h1>Félicitations <?php echo e($user->prenoms); ?> <?php echo e($user->nom); ?> !</h1>
        ...
        <div class="contract-details">
            <p><strong>Numéro de police :</strong> <?php echo e($contrat->numero_police ?? 'N/A'); ?></p>
            <p><strong>Prime annuelle :</strong> <?php echo e($contrat->prime_standard ? number_format($contrat->prime_standard, 0, ',', ' ') : '0'); ?> FCFA</p>
        ...
        <div style="text-align: center;">
            <a href="<?php echo e(config('app.url')); ?>/login" class="button">🚀 Se connecter maintenant</a>
        </div>
...
<?php /**PATH G:\projects\amp\amp_backend\resources\views\emails\contract_credentials.blade.php ENDPATH**/ ?>