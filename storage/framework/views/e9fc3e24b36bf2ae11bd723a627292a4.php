        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            ...
            <form wire:submit="sendOtp">
                ...
                <div style="margin-top: 20px;" class="mt-6 flex justify-between items-center">
                    <a href="<?php echo e(route('filament.admin.auth.login')); ?>" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100">
...
<?php /**PATH G:\projects\amp\amp_backend\resources\views\filament\pages\forgot-password.blade.php ENDPATH**/ ?>