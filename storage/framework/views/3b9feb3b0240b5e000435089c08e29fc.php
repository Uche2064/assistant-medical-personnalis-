    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <table class="info-table">
                <tr>
                    <td>Nom :</td>
                    <td><?php echo e($user->client->nom ?? $user->nom ?? '-'); ?></td>
                </tr>
                <tr>
                    <td>Prénoms :</td>
                    <td><?php echo e($user->client->prenoms ?? $user->prenoms ?? '-'); ?></td>
                </tr>
                <tr>
                    <td>Email :</td>
                ...
                <tr>
                    ...
                    <td><?php echo e($user->client->date_naissance ?? '-'); ?></td>
                </tr>
                <tr>
                    <td>Sexe :</td>
                    <td><?php echo e($user->client->sexe ?? '-'); ?></td>
                </tr>
                <tr>
                    <td>Profession :</td>
                    <td><?php echo e($user->client->profession ?? '-'); ?></td>
                </tr>
                <tr>
                    <td>Adresse :</td>
...
</html> <?php /**PATH G:\projects\amp\amp_backend\resources\views\emails\demande_adhesion_physique.blade.php ENDPATH**/ ?>