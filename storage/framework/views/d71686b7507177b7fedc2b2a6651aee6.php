...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Bonjour <strong><?php echo e($user->personnel->nom ?? 'Utilisateur'); ?></strong>,</p>
            ...
            <div class="account-details">
                ...
                <table>
                    <tr>
                        <td>📧 Email :</td>
                        <td><strong><?php echo e($user->email ?? 'email@exemple.com'); ?></strong></td>
                    </tr>
                    <tr>
                        <td>📅 Date de création :</td>
                        <td><strong><?php echo e($user->created_at->format('d/m/Y à H:i')); ?></strong></td>
                    </tr>
                </table>
            </div>
...
<?php /**PATH G:\projects\amp\amp_backend\resources\views\emails\registered.blade.php ENDPATH**/ ?>