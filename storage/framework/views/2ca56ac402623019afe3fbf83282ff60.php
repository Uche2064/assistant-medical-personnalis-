...
<body>
    <div class="container">
        ...
        <p>Bienvenue <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->personne): ?><?php echo e($user->personne->prenoms); ?> <?php echo e($user->personne->nom); ?><?php else: ?><?php echo e($user->email); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?> ! Votre compte a été créé avec succès.</p>
...
<?php /**PATH G:\projects\amp\amp_backend\resources\views\emails\credentials.blade.php ENDPATH**/ ?>