    ...
    <div class="space-y-6">
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            ...
            <p class="text-gray-600 dark:text-gray-400 mb-6">
                Un code de vérification a été envoyé à <strong><?php echo e(session('forgot_password_email')); ?></strong>.
            ...
            <form wire:submit="verifyOtp">
                ...
                <div style="margin-top: 20px;" class="mt-6 flex justify-between items-center">
                    <a href="<?php echo e(route('filament.admin.pages.forgot-password')); ?>" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100">
                        Retour
                    </a>
