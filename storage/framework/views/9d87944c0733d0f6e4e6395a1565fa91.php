...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Cher(e) <strong><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($demande->type_demandeur === 'medecin_liberal' || $demande->type_demandeur ==='entreprise'): ?> <?php echo e($demande->nom. ' ' . $demande->prenoms); ?> <?php else: ?> <?php echo e($demande->raison_sociale); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></strong>,</p>
...
<?php /**PATH G:\projects\amp\amp_backend\resources\views\emails\rejetee.blade.php ENDPATH**/ ?>