...
<body>
    ...
    <div class="header">
        <?php if(file_exists($entreprise['logo_path'])): ?>
            <img src="<?php echo e($entreprise['logo_path']); ?>" alt="Logo" class="logo">
        <?php endif; ?>
        ...
        <div class="patient-info">
            <div class="patient-details">
                ...
                <?php endif; ?>
                         ...
                         <?php if(isset($assure_principal) && $assure_principal): ?>
             <div style="margin-top: 15px; padding-top: 15px; border-top: 1px solid #ddd;">
                 <div style="font-weight: bold; color: #007bff; margin-bottom: 10px;">Assuré Principal:</div>
                 <div class="patient-details">
                     <div class="detail-item">
                         <div class="detail-label">Nom:</div>
                         <div class="detail-value"><?php echo e($assure_principal['nom']); ?> <?php echo e($assure_principal['prenoms']); ?></div>
                     </div>
                     <div class="detail-item">
                         <div class="detail-label">Date de naissance:</div>
                         <div class="detail-value"><?php echo e($assure_principal['date_naissance'] ?? 'Non renseigné'); ?></div>
                     </div>
                     <div class="detail-item">
                         <div class="detail-label">Sexe:</div>
                         <div class="detail-value"><?php echo e($assure_principal['sexe'] ?? 'Non renseigné'); ?></div>
                     </div>
                     <div class="detail-item">
                         <div class="detail-label">Profession:</div>
                         <div class="detail-value"><?php echo e($assure_principal['profession'] ?? 'Non renseigné'); ?></div>
                     </div>
                     <div class="detail-item">
                         <div class="detail-label">Contact:</div>
                         <div class="detail-value"><?php echo e($assure_principal['contact'] ?? 'Non renseigné'); ?></div>
                     </div>
                     <div class="detail-item">
                         <div class="detail-label">Email:</div>
                         <div class="detail-value"><?php echo e($assure_principal['email'] ?? 'Non renseigné'); ?></div>
                     </div>
                 </div>
             </div>
             <?php endif; ?>
