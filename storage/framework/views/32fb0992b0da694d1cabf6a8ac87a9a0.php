...
<body>
    <div class="header">
        ...
        <div class="photo-container">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($demande->user->assure && $demande->user->photo): ?>
    ...
    <div class="section">
        ...
        <div class="user-info">
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($demande->user->assure && $demande->user->assure->date_naissance): ?>
            <div class="info-row">
                <span class="info-label">Date de naissance :</span>
                <span class="info-value"><?php echo e(\Carbon\Carbon::parse($demande->user->assure->date_naissance)->format('d/m/Y')); ?></span>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($demande->user->assure && $demande->user->assure->sexe): ?>
            <div class="info-row">
...
</html> <?php /**PATH G:\projects\amp\amp_backend\resources\views\pdf\demande-adhesion-physique.blade.php ENDPATH**/ ?>