...
class GestionnaireDashboard extends Page
{
    protected static ?string $navigationLabel = 'Tableau de bord';

    protected static ?string $title = 'Tableau de bord Gestionnaire';

    protected static ?int $navigationSort = 1;

    public static function shouldRegisterNavigation(): bool
    {
        return Auth::check() && Auth::user()->hasRole(RoleEnum::GESTIONNAIRE->value);
    }
    ...
    public function mount(): void
    {
        ...
        if (!$user->hasRole(RoleEnum::GESTIONNAIRE->value)) {
