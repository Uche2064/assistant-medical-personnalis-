...
<body>
    <div class="header">
        ...
        <div class="photo-container">
            @if($demande->user->assure && $demande->user->assure->photo_url)
                <img src="{{ $baseUrl }}/storage/{{ $demande->user->assure->photo_url }}" 
    ...
    <div class="section">
        ...
        <div class="user-info">
            @if ($demande->type_demandeur == \App\Enums\TypeDemandeurEnum::CLIENT)
                 ...
                 @if($demande->user->assure->photo_url)
                 <div class="info-row">
    ...
    <div class="section">
        ...
        <div class="user-info">
            ...
            @if($demande->type_demandeur->value === 'entreprise' && $statistiques['total_employes'] > 0)
            <div class="info-row">
                <span class="info-label">Total d'employés :</span>
                <span class="info-value">{{ $statistiques['total_employes'] }}</span>
            </div>
            @endif
    ...
    <div class="section beneficiaires-section">
        ...
        <div class="beneficiaire-item">
            ...
            <div class="info-row">
                <span class="info-label">Photo :</span>
                <span class="info-value">
                    <img src="{{ $baseUrl }}/storage/{{ $assure->photo_url }}" 
