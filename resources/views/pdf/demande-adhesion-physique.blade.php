...
<body>
    <div class="header">
        ...
        <div class="photo-container">
            @if($demande->user->assure && $demande->user->photo)
                <img src="{{ $baseUrl }}/storage/{{ $demande->user->photo }}" 
    ...
    <div class="section">
        ...
        <div class="user-info">
            ...
            @endif
            @if($demande->user->assure && $demande->user->assure->profession)
            <div class="info-row">
                <span class="info-label">Profession :</span>
                <span class="info-value">{{ $demande->user->assure->profession }}</span>
            </div>
            @endif
            @if($demande->user->assure && $demande->user->assure->date_naissance)
            <div class="info-row">
                <span class="info-label">Date de naissance :</span>
                <span class="info-value">{{ \Carbon\Carbon::parse($demande->user->assure->date_naissance)->format('d/m/Y') }}</span>
            </div>
            @endif
            @if($demande->user->assure && $demande->user->assure->sexe)
            <div class="info-row">
                <span class="info-label">Sexe :</span>
                <span class="info-value">{{ ucfirst($demande->user->assure->sexe->value) }}</span>
            </div>
            @endif
        </div>
    </div>
    ...
    <div class="section beneficiaires-section">
        ...
        @foreach($beneficiaires as $assure)
        <div class="beneficiaire-item">
            ...
            <div class="info-row">
                <span class="info-label">Sexe :</span>
                <span class="info-value">{{ ucfirst($assure->sexe->value) }}</span>
            </div>
            @if($assure->contact)
            <div class="info-row">
            ...
            <div class="info-row">
                ...
                <span class="info-value">{{ ucfirst($assure->lien_parente->value) }}</span>
            </div>
            @endif
    ...
    <div class="section">
        ...
        <div class="user-info">
            <div class="info-row">
                ...
                <span class="info-value">{{ $statistiques['total_personnes'] }}</span>
            </div>
            @if($statistiques['total_beneficiaires'] > 0)
            <div class="info-row">
                <span class="info-label">Total de bénéficiaires :</span>
                <span class="info-value">{{ $statistiques['total_beneficiaires'] }}</span>
            </div>
            @endif
